...
@Component
public class AtlasOpenIDConnectAuthenticationProvider extends AtlasAbstractAuthenticationProvider {

    private static Logger logger = LoggerFactory.getLogger(AtlasOpenIDConnectAuthenticationProvider.class);

    private final UserDetailsService userDetailsService;

    @Inject
    public AtlasOpenIDConnectAuthenticationProvider(UserDetailsService userDetailsService) {
